...
class ArrayStatsOps:
    ...
    def min(self, axis=None, keepdims=False):
        ...
        if axis is None:
            return matlib_stats.min(list(self._flatten()))
    ...
    def count_nonzero(self, axis=None, keepdims=False):
        ...
        if axis is None:
            return matlib_stats.count_nonzero(list(self._flatten()))
    ...
    def norm(self, axis=None, keepdims=False):
        ...
        if axis is None:
            return matlib_stats.norm(list(self._flatten()))
